...
final class PlayableSpecializationApi
{
    /**
    ...
    public function getPlayableSpecializationIndex(string $namespace): RequestInterface
    {
    ...
    public function getPlayableSpecialization(int $specId, string $namespace): RequestInterface
    {
        if ('CN' === $this->region->getName()) {
            throw new UnavailableRegionException('CN does not support this endpoint');
        }
        ...
        $url = '/playable-specialization/'.$specId;
