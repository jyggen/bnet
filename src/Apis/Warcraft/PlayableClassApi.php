...
final class PlayableClassApi
{
    ...
    public function getPlayableClassesIndex(string $namespace): RequestInterface
    {
    ...
    public function getPlayableClass(int $classId, string $namespace): RequestInterface
    {
        if ('CN' === $this->region->getName()) {
            throw new UnavailableRegionException('CN does not support this endpoint');
        }
