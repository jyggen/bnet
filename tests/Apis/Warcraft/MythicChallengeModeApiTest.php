...
final class MythicChallengeModeApiTest extends TestCase
{
    /**
     ...
     */
    public function testGetMythicChallengeModeIndex(RequestFactoryInterface $factory): void
    {
        $api = new MythicChallengeModeApi($factory, new Regions\EU(), 'foobar');
