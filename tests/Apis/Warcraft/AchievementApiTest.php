...
final class AchievementApiTest extends TestCase
{
    /**
     ...
     */
    public function testGetAchievement(RequestFactoryInterface $factory): void
    {
        $api = new AchievementApi($factory, new Regions\EU(), 'foobar');
