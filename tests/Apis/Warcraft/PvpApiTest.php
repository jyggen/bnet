...
final class PvpApiTest extends TestCase
{
    /**
     ...
     */
    public function testGetLeaderboards(RequestFactoryInterface $factory): void
    {
        $api = new PvpApi($factory, new Regions\EU(), 'foobar');
